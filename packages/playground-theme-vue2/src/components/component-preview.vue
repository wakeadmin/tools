<template>
  <div class="component-preview">
    ...
    <el-row>
      ...
      <el-switch v-model="switchValue" style="margin-left: 40px" active-text="Pay by month" inactive-text="Pay by year">
      </el-switch>
    </el-row>
    <h4>Slider</h4>
    ...
    <el-row>
      ...
      <el-rate v-model="rate" class="demo-line" show-score text-color="#ff9900" score-template="{value} points">
      </el-rate>
    </el-row>
    <h4>Transfer</h4>
    <el-row>
    ...
    <el-row style="width: 380px">
      ...
      <el-alert class="demo-item" title="error alert" type="error" description="more text description" show-icon>
      </el-alert>
    </el-row>
    <h4>Loading</h4>
    <el-row>
      ...
      <div role="dialog" aria-modal="true" aria-label="Tips" class="el-dialog" style="margin: 0">
        ...
        <div class="el-dialog__footer">
          <span class="dialog-footer"
            ><button type="button" class="el-button el-button--default"><!----><!----><span>Cancel</span></button>
            <button type="button" class="el-button el-button--primary"><!----><!----><span>Confirm</span></button></span
          >
        </div>
      </div>
    </el-row>
  ...
  export default {
    data() {
      return {
        ...
        avatarData: {
          url: 'https://test-material-1259575047.cos.ap-guangzhou.myqcloud.com/4b93eb5d5cc7472cbe4ce5149d1c73fe.jpg',
        },
      };
    },
  };
